...
$args['opt_name'] = 'accentbox';

//Custom menu icon
//$args['menu_icon'] = '';

//Custom menu title for options page - default is "Options"
$args['menu_title'] = __('AccentBox', 'nhp-opts');

//Custom Page Title for options page - default is "Options"
$args['page_title'] = __('AccentBox', 'nhp-opts');
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'sub_desc' => __('Upload your logo <strong>(138 x 35 px)</strong> using the Upload Button or insert image URL.', 'nhp-opts')
						),
					array(
						'id' => 'mts_favicon',
						'type' => 'upload',
...
$sections[] = array(
				...
				'fields' => array(
					array(
						...
						'sub_desc' => __('AccentBox Theme comes with unlimited color schemes for your theme\'s styling.', 'nhp-opts'),
						'std' => '#79ACCD'
						),
					array(
						'id' => 'mts_layout',
