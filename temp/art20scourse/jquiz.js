	...
	$("#jquiz li ul li").click(function(){
		...
		if (!($(this).parent("ul").hasClass("answered"))) {
			...
			if (!($(this).hasClass("correct"))) {
				...
				$(this).parent().parent().children("div .wrong").prepend('<p>INCORRECT</p>');
				$(this).parent().parent().children("div .wrong").addClass("wrongbox");
				$(this).parent().parent().children("div .wrong").fadeTo(500, 1);
			}
			...
			if ($(this).hasClass("correct")) {
				...
				// animate explanation & add styling depending on answer
				$(this).parent().parent().children("div .correct").prepend('<p>CORRECT</p>');
				$(this).parent().parent().children("div .correct").addClass("rightbox");
				$(this).parent().parent().children("div .correct").fadeTo(750, 1);
			}
			
			if ($('ol.answered').length == howmanyquestions) {
